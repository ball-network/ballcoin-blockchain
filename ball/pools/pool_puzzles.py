...
from ball.consensus.block_rewards import calculate_pool_reward
from ball.consensus.coinbase import pool_parent_id
from ball.pools.pool_wallet_info import LEAVING_POOL, SELF_POOLING, PoolState
...
from ball.wallet.puzzles.singleton_top_layer import puzzle_for_singleton
...
POOL_WAITING_ROOM_MOD = load_clvm_maybe_recompile(
    "pool_waitingroom_innerpuz.clsp", package_or_requirement="ball.pools.puzzles"
)
POOL_MEMBER_MOD = load_clvm_maybe_recompile("pool_member_innerpuz.clsp", package_or_requirement="ball.pools.puzzles")
