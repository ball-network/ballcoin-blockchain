...
from ball.types.blockchain_format.coin import Coin, hash_coin_list
...
from ball.util.api_decorators import api_request, bytes_required, execute_task, peer_required, reply_type
from ball.util.generator_tools import get_block_header
...
class FullNodeAPI:
    ...
    async def request_peers(self, _request: full_node_protocol.RequestPeers, peer: ws.WSBallConnection):
    ...
    @peer_required
    @api_request
    async def new_peak(self, request: full_node_protocol.NewPeak, peer: ws.WSBallConnection) -> Optional[Message]:
        """
