...
from ball.plot_sync.exceptions import AlreadyStartedError, InvalidConnectionTypeError
from ball.plot_sync.util import Constants
from ball.plotting.manager import PlotManager
from ball.plotting.util import PlotInfo
...
from ball.server.ws_connection import NodeType, ProtocolMessageTypes, WSBallConnection, make_msg
from ball.util.generator_tools import list_to_batches
...
class Sender:
    ...
    _connection: Optional[WSBallConnection]
    _sync_id: uint64
    ...
    def set_connection(self, connection: WSBallConnection) -> None:
