...
class SigningMode(Enum):
    ...
    # CHIP-0002 signs the result of sha256tree(cons("Ball Signed Message", message)) using the
    ...
    # Standard BLS signatures used by Ball use the BLS message augmentation scheme
