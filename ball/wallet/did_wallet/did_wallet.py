...
from ball.wallet.derive_keys import master_sk_to_wallet_sk_unhardened
from ball.wallet.did_wallet import did_wallet_puzzles
from ball.wallet.did_wallet.did_info import DIDCoinData, DIDInfo
from ball.wallet.did_wallet.did_wallet_puzzles import match_did_puzzle, uncurry_innerpuz
...
class DIDWallet:
    ...
    async def coin_added(self, coin: Coin, _: uint32, peer: WSBallConnection, parent_coin_data: Optional[DIDCoinData]):
    ...
    async def create_update_spend(
        ...
        if ball_tx is not None and ball_tx.spend_bundle is not None:
            ...
            await self.wallet_state_manager.add_pending_transaction(ball_tx)
