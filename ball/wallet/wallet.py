...
from ball.wallet.puzzles.clawback.metadata import ClawbackMetadata
...
from ball.wallet.puzzles.puzzle_utils import (
...
class Wallet:
    ...
    async def create_tandem_ball_tx(
        ...
        ball_coins = await self.select_coins(fee, tx_config.coin_selection_config)
        [ball_tx] = await self.generate_signed_transaction(
            uint64(0),
    ...
    # WSBallConnection is only imported for type checking
