...
from ball.consensus.coinbase import create_puzzlehash_for_pk, farmer_parent_id, pool_parent_id
from ball.consensus.constants import ConsensusConstants
from ball.consensus.find_fork_point import find_fork_point_in_chain
...
from ball.protocols.wallet_protocol import PuzzleSolutionResponse, RespondPuzzleSolution
...
from ball.wallet.block_record import HeaderBlockRecord
from ball.wallet.cc_wallet.cc_wallet import CCWallet
from ball.wallet.derivation_record import DerivationRecord
from ball.wallet.derive_keys import master_sk_to_backup_sk, master_sk_to_farmer_sk, master_sk_to_wallet_sk
from ball.wallet.did_wallet.did_wallet import DIDWallet
from ball.wallet.key_val_store import KeyValStore
from ball.wallet.rl_wallet.rl_wallet import RLWallet
...
from ball.wallet.util.backup_utils import open_backup_file
...
from ball.wallet.wallet_action import WalletAction
from ball.wallet.wallet_action_store import WalletActionStore
from ball.wallet.wallet_block_store import WalletBlockStore
...
from ball.wallet.wallet_info import WalletInfo, WalletInfoBackup
...
from ball.wallet.wallet_sync_store import WalletSyncStore
...
class WalletStateManager:
    ...
    async def coins_of_interest_added(
        ...
        for coin in coins:
            self.log.info(coin.to_json_dict())
            info = await self.puzzle_store.wallet_info_for_puzzle_hash(coin.puzzle_hash)
            if info is not None:
