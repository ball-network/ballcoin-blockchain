...
from ball.wallet.wallet_weight_proof_handler import WalletWeightProofHandler
...
class WalletBlockchain(BlockchainInterface):
    ...
    async def receive_block(
        ...
        required_iters, error = validate_finished_header_block(
            self.constants, self, block, False, difficulty, sub_slot_iters, difficulty_coefficient, False
        )
