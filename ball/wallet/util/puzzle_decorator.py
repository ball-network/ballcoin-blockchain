...
from ball.wallet.puzzles.clawback.puzzle_decorator import ClawbackPuzzleDecorator
from ball.wallet.puzzles.stake.puzzle_decorator import StakePuzzleDecorator
