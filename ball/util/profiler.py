...
# this will print CPU usage of the ball full node main thread at 1 second increments.
# find a time window of interest and analyze the profile file (which are in pstats format).

# for example:

#   python ball/utils/profiler.py ~/.ball/mainnet/profile 10 20
...
if __name__ == "__main__":
    ...
    def analyze_slot_range(profile_dir: pathlib.Path, first: int, last: int):
        ...
        output_file = "ball-hotspot-%d" % first
        if first < last:
            output_file += "-%d" % last
