...
from ball.consensus.get_block_challenge import get_block_challenge
from ball.consensus.pot_iterations import calculate_iterations_quality, is_overflow_block
            ...
            try:
                ...
                results.append(
                    PreValidationResult(
                        ...
                        successfully_validated_signatures, str(difficulty_coefficient)
                    )
                )
            except Exception:
