...
from ball.consensus.block_root_validation import validate_block_merkle_roots
from ball.full_node.mempool_check_conditions import mempool_check_conditions_dict
...
from ball.types.name_puzzle_condition import NPC
...
from ball.util.generator_tools import (
    additions_for_npc,
            ...
            while not curr_b.is_transaction_block:
                ...
                expected_reward_coins.add(
                    create_timelord_coin(
                        ...
                        calculate_timelord_fee(curr_b.height),
                        constants.GENESIS_CHALLENGE,
                    )
                )
