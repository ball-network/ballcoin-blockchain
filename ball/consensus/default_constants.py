...
DEFAULT_CONSTANTS = ConsensusConstants(
    ...
    # Forks of ball should change this value to provide replay attack protection. This is set to mainnet genesis chall
    AGG_SIG_ME_ADDITIONAL_DATA=bytes.fromhex("12bf2c399d95878363839d030269f18a37111e185a1168f0b3706992600143ff"),
    GENESIS_PRE_FARM_POOL_PUZZLE_HASH=bytes32.fromhex(
        "71ac79ef0f49caec3505153818ab40091c22afe5643e8105c655e0f38f43410c"
    ),
    GENESIS_PRE_FARM_FARMER_PUZZLE_HASH=bytes32.fromhex(
        "71ac79ef0f49caec3505153818ab40091c22afe5643e8105c655e0f38f43410c"
    ),
    GENESIS_COMMUNITY_PUZZLE_HASH=bytes32.fromhex(
        "b0ac572d897e2a2db41115f63b829700d45e01cbcacab5fd548168d407f198f2"
    ),
    ...
    # June 2024
    HARD_FORK_HEIGHT=uint32(2496000),
    HARD_FORK_FIX_HEIGHT=uint32(2496000),
    # June 2027
    PLOT_FILTER_128_HEIGHT=uint32(7542000),
    # June 2030
    PLOT_FILTER_64_HEIGHT=uint32(12592000),
    # June 2033
    PLOT_FILTER_32_HEIGHT=uint32(17643000),
)
