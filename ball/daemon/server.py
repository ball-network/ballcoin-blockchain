...
from ball.server.server import ssl_context_for_server
...
from ball.util.keychain import Keychain, KeyData, passphrase_requirements, supports_os_passphrase_storage
...
if getattr(sys, "frozen", False):
    name_map = {
        "ball_full_node_simulator": "ball_simulator",
    }
