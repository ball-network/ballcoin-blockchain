"""
NOTE: This contains duplicate code from `ball.cmds.plots`.
After `ball plots create` becomes obsolete, consider removing it from there.
"""
...
from ball.plotting.util import Params, add_plot_directory, validate_plot_size
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Ball Proof of Space", "version": chiapos_version, "installed": True}


def plot_ball(args, root_path):
    try:
