...
from ball.rpc.util import wrap_http_handler
from ball.server.outbound_message import NodeType
from ball.server.server import BallServer, ssl_context_for_client, ssl_context_for_server
...
from ball.util.config import str2bool
from ball.util.ints import uint16
from ball.util.json_util import dict_to_json_str
from ball.util.network import WebServer, resolve
from ball.util.ws_message import WsRpcMessage, create_payload, create_payload_dict, format_response, pong
...
class RpcServiceProtocol(Protocol):
    ...
    def server(self) -> BallServer:
        ...
        # a property so as to be read only which allows BallServer to satisfy
        # Optional[BallServer]
        ...
    ...
    def get_connections(self, request_node_type: Optional[NodeType]) -> List[Dict[str, Any]]:
        ...
        ball.rpc.rpc_server.default_get_connections()
        """
        ...
...
def default_get_connections(server: BallServer, request_node_type: Optional[NodeType]) -> List[Dict[str, Any]]:
