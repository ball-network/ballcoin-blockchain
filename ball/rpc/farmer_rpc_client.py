...
from ball.rpc.farmer_rpc_api import PlotInfoRequestData, PlotPathRequestData
from ball.rpc.rpc_client import RpcClient
from ball.types.blockchain_format.sized_bytes import bytes32
from ball.util.misc import dataclass_to_json_dict


class FarmerRpcClient(RpcClient):
    """
    Client to Ball RPC, connects to a local farmer. Uses HTTP/JSON, and converts back from
