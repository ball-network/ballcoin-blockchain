...
from ball.data_layer.data_layer_wallet import DataLayerWallet, Mirror, verify_offer
from ball.rpc.data_layer_rpc_util import marshal
...
if TYPE_CHECKING:
    from ball.data_layer.data_layer import DataLayer
...
class DataLayerRpcApi:
    ...
    def __init__(self, data_layer: DataLayer):  # , wallet: DataLayerWallet):
        ...
        self.service_name = "ball_data_layer"
