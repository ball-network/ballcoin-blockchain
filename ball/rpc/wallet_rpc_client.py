...
from ball.data_layer.data_layer_wallet import Mirror, SingletonRecord
from ball.pools.pool_wallet_info import PoolWalletInfo
from ball.rpc.rpc_client import RpcClient
...
from ball.wallet.conditions import Condition, ConditionValidTimes, conditions_to_json_dicts
...
class WalletRpcClient(RpcClient):
    """
    Client to Ball RPC, connects to a local wallet. Uses HTTP/JSON, and converts back from
    JSON into native python objects before returning. All api calls use POST requests.
    Note that this is not the same as the peer protocol, or wallet protocol (which run Ball's
    ...
    async def nft_mint_bulk(
        ...
        ball_coins: Optional[List[Dict]] = None,
        ball_change_target: Optional[str] = None,
        ...
        request = {
            ...
            "ball_change_target": ball_change_target,
