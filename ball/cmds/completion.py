...
def generate(shell: str) -> None:
    ...
    You can source it directly (performs slower) by running:
        \033[3;33meval "$(ball complete generate)"\033[0m
    or you can save the output to a file:
        \033[3;33mball complete generate > ~/.ball-complete-bash\033[0m
    and source that file with:
        \033[3;33m. ~/.ball-complete-bash\033[0m
    """
    ...
    subprocess.run(["ball"], check=True, env={**os.environ, "_BALL_COMPLETE": f"{shell}_source"})
