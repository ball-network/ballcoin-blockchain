...
@wallet_cmd.command("send", short_help="Send ball to another wallet")
@click.option(
    "-wp",
    "--wallet-rpc-port",
    help="Set the port where the Wallet is hosting the RPC interface. See the rpc_port under wallet in config.yaml",
...
def address_sign_message(wallet_rpc_port: Optional[int], fingerprint: int, address: str, hex_message: str) -> None:
    extra_params: Dict[str, Any] = {"address": address, "message": hex_message, "type": AddressType.BALL}
    import asyncio
...
@wallet_cmd.command("make_offer", short_help="Create an offer of BALL/CATs/NFTs for BALL/CATs/NFTs")
@click.option(
    "-wp",
    "--wallet-rpc-port",
    help="Set the port where the Wallet is hosting the RPC interface. See the rpc_port under wallet in config.yaml",
...
@wallet_cmd.command("find_pool_nft", short_help="recover ball to wallet")
@click.option(
    "-wp",
    "--wallet-rpc-port",
    help="Set the port where the Wallet is hosting the RPC interface. See the rpc_port under wallet in config.yaml",
...
@click.option(
    "-l",
    "--launcher-id",
    help="Set the launcher id, you should get it from ball wallet",
    type=str,
    required=True
)
@click.option(
...
@wallet_cmd.command("recover_pool_nft", short_help="recover nft ball to wallet")
@click.option(
    "-wp",
    "--wallet-rpc-port",
    help="Set the port where the Wallet is hosting the RPC interface. See the rpc_port under wallet in config.yaml",
