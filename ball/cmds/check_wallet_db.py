...
from ball.util.collection import find_duplicates
from ball.util.db_synchronous import db_synchronous_on
from ball.util.db_wrapper import DBWrapper2, execute_fetchone
from ball.util.pprint import print_compact_ranges
...
help_text = """
\b
    The purpose of this command is find potential issues in Ball wallet databases.
    The core ball client currently uses sqlite to store the wallet databases, one database per key.
\b
