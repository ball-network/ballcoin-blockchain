...
from ball.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "38988"
            testnet_introducer = "beta1_introducer.ballcoin.top"
            testnet_dns_introducer = "dns-introducer-testnet7.ballcoin.top"
            testnet = "testnet0"
            ...
            mainnet_port = "38888"
            mainnet_introducer = "introducer.ballcoin.top"
            mainnet_dns_introducer = "dns-introducer.ballcoin.top"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running ball services for changes to take effect")
