...
@click.option("--testnet", is_flag=True, help="Configure this ball install to connect to the testnet")
...
def init_cmd(ctx: click.Context, create_certs: str, fix_ssl_permissions: bool, testnet: bool, **kwargs):
    ...
    - Shut down all ball daemon processes with `ball stop all -d`
...
if not supports_keyring_passphrase():
    from ball.cmds.passphrase_funcs import remove_passphrase_options_from_cmd
