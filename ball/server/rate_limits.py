...
rate_limits_other = {
    ...
    ProtocolMessageTypes.request_stakings: RLSettings(500, 1024 * 1024, 10 * 1024 * 1024),
    ProtocolMessageTypes.respond_stakings: RLSettings(500, 1024 * 1024, 10 * 1024 * 1024),
