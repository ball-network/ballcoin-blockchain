...
from ball.protocols import full_node_protocol
from ball.protocols.full_node_protocol import RespondPeers
from ball.rpc.rpc_server import StateChangedProtocol, default_get_connections
from ball.seeder.crawl_store import CrawlStore
from ball.seeder.peer_record import PeerRecord, PeerReliability
...
class Crawler:
    ...
    async def create_client(
        self, peer_info: PeerInfo, on_connect: Callable[[WSBallConnection], Awaitable[None]]
    ) -> bool:
    ...
    async def connect_task(self, peer: PeerRecord) -> None:
        ...
        async def peer_action(peer: WSBallConnection) -> None:
