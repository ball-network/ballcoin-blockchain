...
APP_VERSION=$1
APP_BUNDLEID="net.ball.blockchain"
APP_NAME="SIT"
...
#   --hardened-runtime=true --provisioning-profile=ballcoinblockchain.provisionprofile \
...
# notarize-cli --file=$DMG_NAME.dmg --bundle-id net.ball.blockchain --username "williejonagvio38@gmail.com" --password "mrdo-yfcr-intb-eyxr"
