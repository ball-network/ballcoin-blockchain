...
Write-Output "Remove unused @ballcoin packages to make cache slim"
...
# Remove `packages/gui/node_modules/@ball` because it causes an error on later `electron-packager` command
Remove-Item "@ball" -Recurse -Force
