...
LAST_EXIT_CODE=$?
ls -l dist/mac*/ball.app/Contents/Resources/app.asar
...
# xcrun notarytool submit --wait --apple-id username --password password --team-id team-id BallCoin-0.1.X.dmg
# Wait until the command returns a success message
#
# Once that is successful, execute the following command":
# xcrun stapler staple BallCoin-0.1.X.dmg
#
# Validate DMG:
# xcrun stapler validate BallCoin-0.1.X.dmg
