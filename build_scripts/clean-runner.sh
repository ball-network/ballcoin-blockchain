...
rm -rf ../venv || true
rm -rf venv || true
rm -rf ball_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf ballcoin-blockchain-gui/build || true
rm -rf ballcoin-blockchain-gui/daemon || true
rm -rf ballcoin-blockchain-gui/node_modules || true
rm ballcoin-blockchain-gui/temp.json || true
( cd "$PWD/ballcoin-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
