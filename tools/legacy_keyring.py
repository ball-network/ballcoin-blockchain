"""
Provides a helper to access the legacy keyring which was supported up to version 1.6.1 of ballcoin-blockchain. To use this
...
from ball.util.errors import KeychainUserNotFound
from ball.util.keychain import KeyData, KeyDataSecrets, get_private_key_user
...
DEFAULT_USER = f"user-ball-{CURRENT_KEY_VERSION}"  # e.g. user-ball-1.8
DEFAULT_SERVICE = f"ball-{DEFAULT_USER}"  # e.g. ball-user-ball-1.8
MAX_KEYS = 100
