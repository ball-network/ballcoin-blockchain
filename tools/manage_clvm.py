...
root = here.parent
cache_path = root.joinpath(".ball_cache", "manage_clvm.json")
...
from ball.types.blockchain_format.serialized_program import SerializedProgram  # noqa: E402
...
top_levels = {"ball"}
hashes_path = root.joinpath("ball/wallet/puzzles/deployed_puzzle_hashes.json")
std_libraries = root.joinpath("ball/wallet/puzzles")
...
main(auto_envvar_prefix="BALL_MANAGE_CLVM")
