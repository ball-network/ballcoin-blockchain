...
$ca_root is the directory containing your current Ball config files
$hash is the header_hash of the [BlockRecord](../ball/consensus/block_record.py)
...
The information for each spend is an "NPC" (Name, Puzzle, Condition):
        ...
        "conditions": a list of condition expressions, as in [condition_opcodes.py](../ball/types/condition_opcodes.py)
...
from ball.wallet.cat_wallet.cat_utils import match_cat_puzzle
