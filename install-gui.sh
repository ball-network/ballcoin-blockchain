...
# Allows overriding the branch or commit to build in ballcoin-blockchain-gui
SUBMODULE_BRANCH=$1
...
# https://github.com/Ball-Network/ballcoin-blockchain/pull/10460#issuecomment-1054492495
